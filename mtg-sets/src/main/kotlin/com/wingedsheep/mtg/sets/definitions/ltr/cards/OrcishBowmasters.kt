...
val OrcishBowmasters = card("Orcish Bowmasters") {
    ...
    oracleText = "Flash\nWhen this creature enters and whenever an opponent draws a card except " +
        "the first one they draw in each of their draw steps, this creature deals 1 damage to " +
        "any target. Then amass Orcs 1. (To amass Orcs 1, put a +1/+1 counter on an Army you " +
        "control. It's also an Orc. If you don't control an Army, create a 0/0 black Orc Army " +
