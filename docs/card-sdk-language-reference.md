...
- `Effects.GrantProtectionFromColor(color, target, duration)` — grant protection from a **fixed** color to a target (no player choice). "{W}: Target creature gains protection from red until end of turn." (Crimson Acolyte).
